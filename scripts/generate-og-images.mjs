...
const cards = [
  ...
  { file: 'events.png', accent: '#00a6a6', title: 'DoW Event Tracker', subtitle: 'Conference-first operational tracking with deep acquisition overlays', kicker: 'adamboas.com' },
