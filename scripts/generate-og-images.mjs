...
const cards = [
	...
	{
		file: 'opportunities.png',
		accent: '#00a6a6',
		title: 'Opportunity Intelligence',
		subtitle: 'Unified SAM.gov and SBIR/STTR opportunity analysis with source-aware workflows',
		kicker: BRAND_KICKER,
		subtitleSize: 24,
		subtitleLineGap: 30,
		subtitleMaxWidthPx: 1020,
	...
	{
		file: 'opportunities-sam.png',
		accent: '#00a6a6',
		title: 'Opportunity Intelligence - SAM.gov',
		subtitle: 'Federal opportunities and signal overlays from SAM.gov sources',
		kicker: BRAND_KICKER,
		subtitleSize: 24,
		subtitleLineGap: 30,
		subtitleMaxWidthPx: 1020,
	...
	{
		file: 'opportunities-sbir.png',
		accent: '#d4a574',
		title: 'Opportunity Intelligence - SBIR/STTR',
		subtitle: 'DoD SBIR and STTR topics with source-specific filters and analysis',
		kicker: BRAND_KICKER,
		subtitleSize: 24,
		subtitleLineGap: 30,
		subtitleMaxWidthPx: 1020,
	...
	},
	{
		...
		accent: '#00a6a6',
		title: 'Profile',
		subtitle: 'Career, speaking engagements, credentials, and delivery record',
		kicker: BRAND_KICKER,
		subtitleSize: 24,
		subtitleLineGap: 30,
		subtitleMaxWidthPx: 1020,
	...
	},
	{
		...
		accent: '#00a6a6',
		title: 'Speaking',
		subtitle: 'Talks and panels across AI, autonomy, governance, and implementation',
		kicker: BRAND_KICKER,
		subtitleSize: 24,
		subtitleLineGap: 30,
		subtitleMaxWidthPx: 1020,
...
function svgTemplate({
	...
	const titleLines = wrapTextByWidth(title, {
		fontSize: titleSize,
