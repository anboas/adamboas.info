...
Notes:
- Data source: SAM.gov Contract Awards API (`/contract-awards/v1/search`).
- Query basis: `solicitationID` exact match, `awardOrIDV=Award`.
- Signals do not imply direct continuity without analyst validation.
