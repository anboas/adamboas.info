...
export const GET: APIRoute = () => {
	const body = [
		...
		`- Home: ${absoluteUrl('/')}`,
		`- Selected strategic work: ${absoluteUrl('/strategic-work/')}`,
		...
		`- opportunities lineage: ${absoluteUrl('/opportunities/lineage.json')}`,
		...
		`- schema (opportunities lineage): ${absoluteUrl('/schemas/opportunities-lineage.schema.json')}`,
		'',
		'## Crawl policy notes',
		'- Prefer canonical URLs and sitemap-index ordering.',
		'- Prioritize /writing/ and detail pages for authored material.',
		'- Use /strategic-work/ for sanitized public evidence of strategy, capture, transition, and governance work.',
